export { default as HomePage } from './ecommerce/HomePage';
export { default as LoginPage } from './ecommerce/LoginPage';
export { default as InformationPage } from './ecommerce/InformationPage';
